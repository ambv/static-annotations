...
expression, SyntaxError is raised at compile time.  Since names aren't
resolved at that time, no attempt is made to validate whether used
names are accessible or not.
...
Deliberately using a name before it was defined in module is called a
forward reference.
